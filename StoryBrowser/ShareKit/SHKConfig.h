...
#define SHKMyAppName			@"Story Browser"
#define SHKMyAppURL				@"http://itunes.apple.com/us/app/remote/id463189225"
...
#define SHKDeliciousConsumerKey		@"dj0yJmk9a2dBeWVmSmthRzNpJmQ9WVdrOVRXOU5iR1ZCTnpnbWNHbzlNelkzTnpneU5EWXkmcz1jb25zdW1lcnNlY3JldCZ4PTA5"
#define SHKDeliciousSecretKey		@"3f004ef2f1d4429f75a320b8593d8c26bf6c9398"
...
#define SHKFacebookKey				@"265278986825712"
#define SHKFacebookSecret			@"f8db5f21caf25aea12f85aba6dd967f5"
#define SHKFacebookSessionProxyURL  @""

// Read It Later - http://readitlaterlist.com/api/?shk
#define SHKReadItLaterKey			@"86bp8R56Ax92dh8429gsFuqqc7dZA733"
 ...
 */
#define SHKTwitterConsumerKey		@"Sq0vwzvhYcMKnJnTomWw0g"
#define SHKTwitterSecret			@"tvtgyYOT9RIC8WlvlmifXqawpAi44eTGtZNqskCLI"
#define SHKTwitterCallbackUrl		@"http://storybrowser.com" // You need to set this if using OAuth, see note above (xAuth users can skip it)
#define SHKTwitterUseXAuth			0 // To use xAuth, set to 1
#define SHKTwitterUsername			@"storybrowser" // Enter your app's twitter account if you'd like to ask the user to follow it when logging in. (Only for xAuth)

// Bit.ly (for shortening URLs on Twitter) - http://bit.ly/account/register - after signup: http://bit.ly/a/your_api_key
#define SHKBitLyLogin				@"storybrowser"
#define SHKBitLyKey					@"R_d5430ecd51440efa49e89004ec587f5e"
